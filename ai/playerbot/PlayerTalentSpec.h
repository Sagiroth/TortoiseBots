...
enum class PlayerTalentSpec : uint8
{
    ...
    // Keep the historical numeric slots so UpdateTalentSpec's arithmetic
    // mapping for the nine Vanilla classes remains stable after removing DK.
    TALENT_SPEC_SHAMAN_ELEMENTAL = 19,
    TALENT_SPEC_SHAMAN_ENHANCEMENT,
    TALENT_SPEC_SHAMAN_RESTORATION,
    TALENT_SPEC_MAGE_ARCANE = 22,
    TALENT_SPEC_MAGE_FIRE,
    TALENT_SPEC_MAGE_FROST,
    TALENT_SPEC_WARLOCK_AFFLICTION = 25,
