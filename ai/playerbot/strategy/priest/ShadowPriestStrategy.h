// Forward-ported from mod-playerbots Priest/Strategy/ShadowPriestStrategy.h
/*
...
#ifndef PLAYERBOTS_SHADOWPRIESTSTRATEGY_H
#define PLAYERBOTS_SHADOWPRIESTSTRATEGY_H
