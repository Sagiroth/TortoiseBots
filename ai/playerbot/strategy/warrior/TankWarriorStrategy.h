// Forward-ported from mod-playerbots Warrior/Strategy/TankWarriorStrategy.h
/*
...
#ifndef PLAYERBOTS_TANKWARRIORSTRATEGY_H
#define PLAYERBOTS_TANKWARRIORSTRATEGY_H
