...
namespace ai
{
	...
	{
	public:
		// Turtle ranks R1-8 (679..10333): melee strike with Mending Light
	...
	{
	public:
		// Turtle Bulwark of the Righteous R1-2 (51346/51565): shield bash
    ...
    public:
        ...
        std::string GetCrowdControlSpellName() const override { return "turn undead"; }
