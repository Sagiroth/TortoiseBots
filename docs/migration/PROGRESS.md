...
| --- | --- | --- | --- |
| M0–M10 (all) | `migration/behavior-migration` (16 commits from `main`) | https://github.com/Sagiroth/TortoiseBots/pull/83 (draft → `main`) | open; module build running (BUILD_PLAYERBOTS=ON, static) |
